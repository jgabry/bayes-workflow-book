...
Some guidance on (a) how to construct a Bayesian model, and (b) how to do this construction in Stan.  Ideally the reader would learn to write a Stan model directly, rather than first writing it in math and then translating to Stan.
