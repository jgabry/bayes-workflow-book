...
what is a prior?, how does it combine with data?, what are types of priors?, what is the role of the likelihood?, problems with non informative priors and other examples
...
First generate your data in R, by drawing a single observation from a normal distribution (with arbitrarily chose mean and variance).
```
...
## [REVISIT] Concentration of the likelihood
...
models above, where each additional data point adds another term to
