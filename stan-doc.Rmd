...
We recommend working through this book using the textbooks Bayesian
Data Analysis, third edition (BDA3) and Statistical Rethinking: A Bayesian Course with
Examples in R and Stan as references on the concepts, and using the
Stan User's Guide and Reference Manual when necessary to clarify programming issues.  We discuss BDA in detail in a later chapter of this book.
...
Currently the User's Guide has Stan programs and code fragments, but no examples that can be directly run from R or Python or the command line.
...
The Stan case studies (https://mc-stan.org/users/documentation/case-studies) are discussed in a later chaper of this book.  In addiiton, a large set of models translated from BUGS, applied regression modeling examples, and examples from other books here: https://github.com/stan-dev/example-models/wiki.
